...
matriz_t * matriz_criar(int linhas, int colunas) {
    ...
    elemento_t * temp = NULL; //temporario
    elemento_t * prim = NULL; //primeiro
...
void matriz_destruir(matriz_t * m) {
    elemento_t * ec = m->inicio; //ponteiro aponta para o primeiro elemento da matriz
    elemento_t * el = NULL;
    elemento_t * aux = NULL;
...
/* funcao que printa a matriz e os ponteiros */
